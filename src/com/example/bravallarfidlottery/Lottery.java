...
package com.example.bravallarfidlottery;
...
public class Lottery extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!mNfcAdapter.isEnabled()) {
            ...
            mTextView.setText(R.string.rfid);
        }
    ...
    protected void onNewIntent(Intent intent) {
         ...
         * documentation. In our case this method gets called, when the user
         * attaches a Tag to the device.
         */
        handleIntent(intent);
    }
    ...
    /**
     * @param activity The corresponding {@link Activity} requesting the
     *            foreground dispatch.
    ...
    /**
     * @param activity The corresponding {@link BaseActivity} requesting to stop
    ...
    private class NdefReaderTask extends AsyncTask<Tag, Void, String> {
        ...
        /**
         * Background task for reading the data. Do not block the UI thread
         * while reading.
         * 
        ...
        private String readText(NdefRecord record) throws UnsupportedEncodingException {
             ...
             * 3.2.1 http://www.nfc-forum.org/specs/ bit_7 defines encoding
             * bit_6 reserved for future use, must be 0 bit_5..0 length of IANA
             * language code
             */
